    (() => {
      ...
      const translations = {
        zh: {
          ...
          heroServer: '我的服务器', heroPortal: '登录订阅中心', heroTutorial: '怎么导入订阅',
        ...
        en: {
          ...
          heroServer: 'View server status', heroPortal: 'VPS subscription portal', heroTutorial: 'Import a subscription',
